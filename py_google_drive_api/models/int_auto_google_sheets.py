...
class PyGoogleSale(models.Model):
    _inherit = 'stock.picking'

    def google_sheets_api_int(self):
        # Для регистрации
        ...
        for el in self:
            ...
            # Присвоение значений
            values_odoo = {'Статус производства': state_int,
                           'Упаковка': pack,
                           'Дата производства': str(date_int)}
